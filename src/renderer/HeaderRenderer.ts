...
export class HeaderRenderer {
    ...
    public drawColumnHeaders(startColumn: number, endColumn: number, scrollLeft: number): void {
    ...
    public drawRowHeaders(startRow: number, endRow: number, scrollTop: number): void {
        const selection = this.selectionManager.getSelection();
        this.ctx.fillStyle = HEADER_BACKGROUND;
        this.ctx.fillRect(
            0,
