...
export class HeaderRenderer {
    constructor(selectionManager, ctx, canvas, rowColumnManager) {
    ...
    drawRowHeaders(startRow, endRow, scrollTop) {
        ...
        for (let row = startRow; row <= endRow; row++) {
            ...
            this.ctx.strokeRect(0, currentY, ROW_HEADER_WIDTH, currentHeight);
            this.ctx.fillStyle = TEXT_COLOR; //Otherwise the letters become blue too
            this.ctx.fillText(String(row + 1), ROW_HEADER_WIDTH / 2, currentY + currentHeight / 2);
